      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden sticky top-0 z-30 flex items-center justify-between gap-3 px-4 h-14 border-b border-border bg-background/80 backdrop-blur-xl shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#B9F495] to-[#9ee86f] flex items-center justify-center shadow-sm">
        ...
        <main className={cn("flex-1 relative", !isFullBleed && "overflow-y-auto")}>
          {isFullBleed ? (
            ...
            <div className="flex-1 p-4 md:p-6 lg:p-8 max-w-[1920px] mx-auto w-full animate-fade-in">
              {children}
            </div>
          )}
        </main>
